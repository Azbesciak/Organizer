...
//                Toast.makeText(getApplicationContext(),foodFormEvent.getName() + " zapisany",Toast.LENGTH_SHORT).show();
            }else {
//                i++;
            }
        }
//        if(i!=0){
//            Toast.makeText(getApplicationContext(),"ilosc niewpisanych rekordów: " + i, Toast.LENGTH_SHORT).show();
//        }
